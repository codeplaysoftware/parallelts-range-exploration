...
int main() {
...

  {
    ...
    std::experimental::transform(exec, view::transform(view::drop(ga, vsize), Add3{}), gb, TripleNum{});
  }

  std::vector<int> gold(vsize);

  transform(view::transform(view::drop(va, vsize), Add3{}), gold.begin(), TripleNum{});
