...
int main() {
...

  {
    ...
    std::experimental::transform(exec, view::transform(view::take(ga, vsize), Add3{}), gb, TripleNum{});
  }

  std::vector<int> gold(vsize);

  transform(view::transform(view::take(va, vsize), Add3{}), gold.begin(), TripleNum{});
